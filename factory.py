...
def generate_partial_patient():
    ...
    patient["resident_name"] = f"PARTIAL - {patient['resident_name']}"
...
def generate_failed_patient():
    ...
    if missing_type == 'clinical_notes':
        ...
        patient["resident_name"] = f"FAILED - {patient['resident_name']} (No Notes)"
    elif missing_type == 'state':
        patient["state"] = ""
        patient["resident_name"] = f"FAILED - {patient['resident_name']} (No State)"
    elif missing_type == 'dob':
        patient["dob"] = ""
        patient["resident_name"] = f"FAILED - {patient['resident_name']} (No DOB)"
    return patient
